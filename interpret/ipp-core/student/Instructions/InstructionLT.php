...
class InstructionLT extends Instruction {
    ...
    public function execute(): void {
        ...
        if ($type1 === "nil" || $type2 === "nil") {
            throw new OperandTypeException("Instruction LT expects two arguments of type int, bool or string");
        }
        if ($type1 !== $type2 ) {
            throw new OperandTypeException("Instruction LT expects two arguments of the same type");
        }
